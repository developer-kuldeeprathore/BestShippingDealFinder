...
{
    public class DelhiveryProviderService : ResponseHandlerBase, IShippingProvider
    {
        private readonly IApiClientService _apiClientService;
        private ShippingCostResponse _shippingCostResponse;

        public DelhiveryProviderService(IApiClientService apiClientService)
        {
        ...
        public async Task<ShippingCostResponse> FetchShippingCost(ShippingRequestModel shippingRequest)
        {
            ...
            await _apiClientService.MakeRequest(Models.ShippingProviders.Delhivery, shippingRequest, xmlResponse =>
            {
